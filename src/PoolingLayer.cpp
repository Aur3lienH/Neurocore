...
{
    layerShape = new LayerShape((previousActivation->dimensions[0] - filterSize) / stride + 1, (previousActivation->dimensions[1] - filterSize) / stride + 1, previousActivation->dimensions[2]);
