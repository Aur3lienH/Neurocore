...
public:
    ...
    void MultiplyByTransposeAndAddToRes(const Matrix<other_rows, cols>& other, Matrix<rows, other_rows>& res) requires(GPU);
...
template <int rows, int cols, int dims, bool GPU>
template <int other_rows>
void Matrix<rows, cols, dims, GPU>::MultiplyByTransposeAndAddToRes(const Matrix<other_rows, cols>& other, Matrix<rows, other_rows>& res) requires(GPU)
{
    checkCUBLAS(
...
template <int rows, int cols, int dims, bool GPU>
template <int other_cols>
void Matrix<rows, cols, dims, GPU>::MultiplyTransposeBy(const Matrix<rows, other_cols>& other, Matrix<cols, other_cols>& res) requires(GPU)
{
    checkCUBLAS(
