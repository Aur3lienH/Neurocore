...
Matrix<rows, cols, dims, GPU>::Matrix(std::initializer_list<float> values) {
    ...
    template<int rows, int cols, int dims, bool GPU>
    Matrix<rows, cols, dims, GPU>::Matrix(py::array_t<float> &input) {
    ...
    template<int rows, int cols, int dims, bool GPU>
    py::object Matrix<rows, cols, dims, GPU>::ConvertToArray(py::array_t<float> &input) {
        py::buffer_info buf = input.request();
        if (buf.ndim > 4)
    ...
    template<int rows, int cols, int dims, bool GPU>
    py::array_t<float> Matrix<rows, cols, dims, GPU>::ToNumpy() {
...
template<int rows, int cols, int size, bool GPU>
constexpr int Matrix<rows, cols, size, GPU>::GetRows() {
    return rows;
}

template<int rows, int cols, int size, bool GPU>
constexpr int Matrix<rows, cols, size, GPU>::GetCols() {
    return cols;
}

template<int rows, int cols, int size, bool GPU>
constexpr int Matrix<rows, cols, size, GPU>::GetDims() {
    return size;
}

template<int rows, int cols, int dims, bool GPU>
constexpr int Matrix<rows, cols, dims, GPU>::GetMatrixSize() {
    return rows * cols;
}
...
#endif
    int size = this->GetRows() * this->GetCols() * this->GetDims();
...
template<int rows, int cols, int dims, bool GPU>
constexpr int Matrix<rows, cols, dims, GPU>::GetSize() {
